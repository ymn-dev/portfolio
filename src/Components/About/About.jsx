  ...
  return (
    <div className="bg-black  flex flex-col gap-4 justify-between items-center text-white p-10 xl:px-48">
      ...
      <p className="text-2xl font-semibold w-10/12">
        <span>
          I'm a developer from Bangkok, Thailand. Graduated from Generation Thailand Junior Software Developer#5 Bootcamp and earned a Bachelor's degree in Computer Science from <a href="#">Silpakorn University</a>. These educations
          provided me with a robust foundation to write functional code for both frontend and backend.
        </span>
        <br className="" />
