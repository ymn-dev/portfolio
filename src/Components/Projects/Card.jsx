...
const Card = (props) => {
  return (
    <div className="flex lg:flex-row flex-col items-center justify-center lg:gap-16 gap-8  w-full 2xl:px-48">
      <div className="lg:w-3/5 w-full mx-auto " id="leftContainer">
        <img src={props.Picture} alt="" className=" w-full h-auto shadow-stone-500 shadow-lg hover:scale-105 duration-150 " />
      </div>
      <div className="flex flex-col my-auto lg:w-2/5 sm:w-full  justify-between lg:gap-[2rem] sm:gap-[1.5rem] font-semibold" id="rightContainer">
